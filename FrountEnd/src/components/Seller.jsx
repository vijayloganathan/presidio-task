        ...
        >
          <div className="row d-flex justify-content-center">
            <div className="col-md-3 bg-light text-dark text-center m-3 p-2 h4">
              <button className="btn btn-primary align-items-center m-5">
                <p className="h1 text-center ">+</p>
              </button>
              <p>Add new Land For Sale</p>
            </div>
            <div className="col-md-3 bg-light text-dark text-center m-3 p-2 h4">
              <p>Place : Salem</p>
              <p>Area : 4-Roads</p>
              ...
              <div className="row">
                <div className="col-md-6">
                  <button className="btn btn-block btn-primary m-1">
                    Edit Deails
                  </button>
                </div>
                <div className="col-md-6">
                  <button className="btn btn-block btn-danger m-1">
                    View Deails
                  </button>
                </div>
              </div>
